...
var watts = amps * volts;// this where you multiply amps times volts to get you wattage
 ...
 (doorsClosed == 3) ? prompt ("All doors closed to run") : prompt ("You can not run, all doors not closed");

 if (watts >= 30000){
	prompt ("You have enough voltage to run") ;}//this is where the out come of voltage
